...
是的，整篇论文的思路很清爽，没有拖泥带水堆砌模块，个人认为是一次第一性原理很好的实践。最终的效果也挺好，在两个数据集上相对最佳基线的 MRR 提升为 14% 和 16%。这也是论文最大的卖点，也算是产出了一篇新的 SOTA 了。目前这篇论文是计算机学报在投。
...
在写[知识图谱论文]({{< relref "#知识图谱论文" >}})和折腾上述两个模型之后，我有点迷茫了，感觉自己的探索貌似和学术界的主流相去甚远，难以快速产出论文。目前最可行的方向可能就是在英伟达 TTT-E2E 的基础之上尝试缓解模型在线更新时的漂移问题。

另外，我的科研方法更类似深度优先搜索，搜索面实在是有些太窄了。直观上来说，要解决这个问题只能够多读文献，但这样效率太低并且容易迷失在各种各样的方法之中。于是我准备提升一下自己的科研工作流程，引入更多的 Agent 框架，保证质量的同时来加速科研进度。目前也正在体验现行的解决方案：比如哈佛大学学者构建的 Zotero 文献管理 Agent 插件：[Beaver](https://www.beaverapp.ai/)。但只是有文献管理的工具只是解决了思路来源和现状分析的问题，我还需要一个能够稳定并深入探索某一个想法的工具。由于我本来对这个问题就有[一些思路](https://morethan987.github.io/blog/trials-and-growth/#%E7%9F%A5%E8%AF%86%E5%9B%BE%E8%B0%B1%E8%AE%BA%E6%96%87:~:text=%E5%BD%93%E7%84%B6%EF%BC%8C%E9%81%B5%E5%BE%AA%E7%9D%80,%E4%B8%AD%E7%9A%84%E6%99%BA%E5%AD%90%E4%B8%80%E6%A0%B7%E3%80%82)，于是我正在着手实现我的思路。
