...
当然，口说无凭，下面就是我本地编译运行 Hugo 得到的输出：
...
中英文总共 104 个网页页面花费时间 0.872 秒，并且包含构建本地服务的时间，这个速度确实没什么好挑剔的了。
...
正如我在[一次写插件经历](https://morethan987.github.io/blog/plugin-writing-experience/)中所写，很多个人博客网站从一开始的火热到最终的沉寂可能只需要短短一年的时间。
